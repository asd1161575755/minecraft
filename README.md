...
- docker run -d --restart=unless-stopped -v /data/:/data/ -v /server/config:/server/config -v /server/mods:/server/mods -p 25565:25565 -p 25575:25575 minecraft-server-fabric
